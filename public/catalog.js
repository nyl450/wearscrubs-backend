...
const COLOR_META = {
    ...
    // Gown Polos colors
    'navy':         { label: 'Navy',         hex: '#242738' },
    'tosca':        { label: 'Tosca',        hex: '#02869d' },
    'orange':       { label: 'Orange',       hex: '#d7a353' },
    'blue':         { label: 'Blue',         hex: '#7a97b5' },
    'off-white':    { label: 'Off White',    hex: '#dee0df' },
    'grey':         { label: 'Grey',         hex: '#bbb5b5' },
